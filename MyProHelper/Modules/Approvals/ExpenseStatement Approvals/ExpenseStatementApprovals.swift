...
enum ExpenseStatementApprovalField: String {
...
class ExpenseStatementApprovals: BaseDataTableView<Approval, ExpenseStatementApprovalField>, Storyboarded,ClassBDelegate,BDelegate, RDelegate {
    func rejectFunction() {
