...
enum WorkerOrderApprovalField: String {
    ...
    case REQUESTED_DATE          = "Approved Date"
    case ATTACHMENTS_date             = "Attachments"
...
class WorkerOrderApprovals: BaseDataTableView<Approval, WorkerOrderApprovalField>, Storyboarded,ClassBDelegate,BDelegate, RDelegate {
    func rejectFunction() {
    ...
    override func viewDidLoad() {
        viewModel = WorkerOrderModal(delegate: self)
