...
enum InvoiceApprovalField: String {
    
    case WORKER_NAME             = "Worker"
...
class InvoiceApprovals: BaseDataTableView<Approval, InvoiceApprovalField>, Storyboarded,ClassBDelegate,BDelegate, RDelegate {
    func rejectFunction() {
    ...
    override func viewDidLoad() {
        viewModel = InvoiceListModel(delegate: self)
        super.viewDidLoad()
    }
